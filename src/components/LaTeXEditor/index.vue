    ...
    <div class="container">
      <div class="left">
        <div class="input-area">
          <TextArea v-model:value="latex" placeholder=" LaTeX Equation" ref="textAreaRef" />
        </div>
        <div class="preview">
          <div class="placeholder" v-if="!latex">EquationPreview</div>
...
const update = () => {
  if (!latex.value) return message.error('Equation')
