  ...
  <div class="shape-element-operate">
    ...
    <template v-if="handlerVisible">
      <ResizeHandler
        ...
        @touchstart.stop.prevent="($event: TouchEvent) => scaleElement($event, elementInfo, point.direction)"
      />
      <RotateHandler
...
const props = defineProps<{
  ...
  scaleElement: (e: MouseEvent | TouchEvent, element: PPTShapeElement, command: OperateResizeHandlers) => void
