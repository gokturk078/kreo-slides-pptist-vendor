<template>
  <div class="media-input">
    ...
    <template v-if="type === 'video'">
      <Input v-model:value="videoSrc" placeholder="Enter a video URL, e.g. https://example.com/video.mp4"></Input>
      <div class="btns">
    ...
    <template v-if="type === 'audio'">
      <Input v-model:value="audioSrc" placeholder="Enter an audio URL, e.g. https://example.com/audio.mp3"></Input>
      <div class="btns">
...
const insertVideo = () => {
  if (!videoSrc.value) return message.error('Enter a valid video URL first.')
  emit('insertVideo', { src: videoSrc.value })
}

const insertAudio = () => {
  if (!audioSrc.value) return message.error('Enter a valid audio URL first.')
