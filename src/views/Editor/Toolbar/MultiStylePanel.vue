<template>
  <div class="multi-style-panel">
    ...
    >
      <RadioButton value="left" style="flex: 1;" v-tooltip="'Align'"><i-icon-park-outline:align-text-left /></RadioButton>
      <RadioButton value="center" style="flex: 1;" v-tooltip="'Align center'"><i-icon-park-outline:align-text-center /></RadioButton>
      <RadioButton value="right" style="flex: 1;" v-tooltip="'Align'"><i-icon-park-outline:align-text-right /></RadioButton>
      <RadioButton value="justify" style="flex: 1;" v-tooltip="'Align'"><i-icon-park-outline:align-text-both /></RadioButton>
    </RadioGroup>
  </div>
</template>
