...
const defaultFilters: FilterOption[] = [
  { label: '', key: 'blur', default: 0, value: 0, unit: 'px', max: 10, step: 1 },
  { label: '', key: 'brightness', default: 100, value: 100, unit: '%', max: 200, step: 5 },
  { label: '', key: 'contrast', default: 100, value: 100, unit: '%', max: 200, step: 5 },
  { label: '', key: 'grayscale', default: 0, value: 0, unit: '%', max: 100, step: 5 },
  { label: '', key: 'saturate', default: 100, value: 100, unit: '%', max: 200, step: 5 },
  { label: '', key: 'hue-rotate', default: 0, value: 0, unit: 'deg', max: 360, step: 10 },
  { label: '', key: 'sepia', default: 0, value: 0, unit: '%', max: 100, step: 5 },
  { label: '', key: 'invert', default: 0, value: 0, unit: '%', max: 100, step: 5 },
...
const presetFilters: {
  ...
  { label: '', values: { 'grayscale': '100%' } },
  { label: '', values: { 'sepia': '50%', 'contrast': '110%', 'brightness': '90%' } },
  { label: '', values: { 'contrast': '150%' } },
  { label: '', values: { 'brightness': '110%', 'contrast': '90%' } },
  { label: '', values: { 'sepia': '30%', 'saturate': '135%' } },
  { label: '', values: { 'brightness': '110%', 'contrast': '110%' } },
  { label: '', values: { 'saturate': '200%' } },
  { label: '', values: { 'blur': '2px' } },
  { label: '', values: { 'invert': '100%' } },
]
