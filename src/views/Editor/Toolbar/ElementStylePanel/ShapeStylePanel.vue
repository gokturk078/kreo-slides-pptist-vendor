<template>
  <div class="shape-style-panel">
    ...
    <template v-if="handleShapeElement.text?.content">
      ...
      <div class="row">
        <NumberInput
          ...
          style="width: 45%;"
        >
          <template #prefix>Top inset</template>
        </NumberInput>
        ...
        <NumberInput
          ...
          style="width: 45%;"
        >
          <template #prefix>Bottom inset</template>
        </NumberInput>
      </div>
      <div class="row">
        <NumberInput
          ...
          style="width: 45%;"
        >
          <template #prefix>Left inset</template>
        </NumberInput>
        <div style="width: 10%;"></div>
        <NumberInput
          :min="0"
          ...
          style="width: 45%;"
        >
          <template #prefix>Right inset</template>
        </NumberInput>
      </div>
    ...
    <div class="row">
      ...
      ><i-icon-park-outline:format-brush /> ShapeFormat painter</CheckboxButton>
    </div>
  </div>
</template>
