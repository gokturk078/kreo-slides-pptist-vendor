<template>
  <div class="line-style-panel">
    ...
    <div class="row">
      <div style="width: 40%;">Start arrow</div>
      <SelectCustom style="width: 60%;">
        <template #options>
    ...
    <div class="row">
      <div style="width: 40%;">End arrow</div>
      <SelectCustom style="width: 60%;">
        <template #options>
    ...
    <div class="row" v-if="handleLineElement.broken2">
      <div style="width: 40%;">Connector routing</div>
      <Select 
        style="width: 60%;"
    ...
    <div class="row">
      <Button style="flex: 1;" @click="updateLine({ start: handleLineElement.end, end: handleLineElement.start })"><i-icon-park-outline:switch /> Reverse line</Button>
    </div>
