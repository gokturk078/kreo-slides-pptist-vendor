  ...
  <div class="table-style-panel">
    ...
    <ButtonGroup class="row" passive>
      ...
      <Popover trigger="click" style="width: 50%;">
        ...
        <TextColorButton last v-tooltip="'Fill'" :color="textAttrs.backcolor">
    ...
    >
      <RadioButton value="left" v-tooltip="'Align'" style="flex: 1;"><i-icon-park-outline:align-text-left /></RadioButton>
      <RadioButton value="center" v-tooltip="'Align center'" style="flex: 1;"><i-icon-park-outline:align-text-center /></RadioButton>
      <RadioButton value="right" v-tooltip="'Align'" style="flex: 1;"><i-icon-park-outline:align-text-right /></RadioButton>
      <RadioButton value="justify" v-tooltip="'Align'" style="flex: 1;"><i-icon-park-outline:align-text-both /></RadioButton>
    </RadioGroup>
    ...
    >
      <RadioButton value="top" v-tooltip="'Align'" style="flex: 1;"><i-icon-park-outline:align-text-top-one /></RadioButton>
      <RadioButton value="middle" v-tooltip="'Align center'" style="flex: 1;"><i-icon-park-outline:align-text-middle-one /></RadioButton>
      <RadioButton value="bottom" v-tooltip="'Align'" style="flex: 1;"><i-icon-park-outline:align-text-bottom-one /></RadioButton>
    </RadioGroup>
    ...
    <div class="row theme-switch">
      <div style="width: 40%;">Use table theme</div>
