  ...
  <div class="slide-design-panel">
    ...
    <div class="row">
      <Select 
        ...
        :options="[
          { label: 'Wide 16 : 9', value: 0.5625 },
          { label: 'Wide 16 : 10', value: 0.625 },
    ...
    <div class="row">
      <Button style="flex: 1;" @click="applyFontToAllSlides(theme.fontName)"><i-icon-park-outline:check /> Unify font</Button>
    </div>
    ...
    <div class="theme-list">
      ...
      >
        <div class="theme-item-content">
          <div class="text" :style="{ color: item.fontColor }">Theme preview</div>
          <div class="colors">
          ...
          <div class="btns">
            ...
            <Button type="primary" size="small" style="margin-top: 3px;" @click="applyPresetTheme(item, true)">Set and apply</Button>
          </div>
        </div>
      </div>
    </div>
