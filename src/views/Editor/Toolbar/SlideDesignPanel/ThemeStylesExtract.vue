  ...
  <div class="theme-styles-extract">
    ...
    <div class="content">
      ...
      <div class="config-item" v-if="themeStyles.themeColors.length">
        <div class="label">Theme color <span class="tip">(click a swatch to exclude it)</span></div>
    ...
    <div class="btns">
      <Button class="btn" type="primary" @click="updateAllThemes()"><i-icon-park-outline:check /> Save selected settings as theme</Button>
    </div>
  </div>
</template>
