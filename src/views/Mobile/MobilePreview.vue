<template>
  <div class="mobile-preview" ref="mobileRef">
    ...
    <div class="menu">
      <div class="menu-item" @click="changeMode('editor')"><i-icon-park-outline:edit class="icon" /> </div>
      <Divider type="vertical" style="height: 30px;" />
      <div class="menu-item" @click="changeMode('player')"><i-icon-park-outline:full-screen-play class="icon" /> </div>
      <Divider type="vertical" style="height: 30px;" />
