      ...
      <div class="tools" @mousedown.stop>
        <div class="tool-content">
          <Popover placement="top" trigger="manual" :value="sizePopoverType === 'pen'" @hide="sizePopoverType = ''">
            ...
            <div class="btn" :class="{ 'active': writingBoardModel === 'pen' }" v-tooltip="''" @click="changeModel('pen')">
          ...
          <Popover placement="top" trigger="manual" :value="sizePopoverType === 'mark'" @hide="sizePopoverType = ''">
            ...
            <div class="btn" :class="{ 'active': writingBoardModel === 'mark' }" v-tooltip="''" @click="changeModel('mark')">
          ...
          <Popover placement="top" trigger="manual" :value="sizePopoverType === 'eraser'" @hide="sizePopoverType = ''">
            <template #content>
              <div class="setting">
                <div class="label">LargeSmall：</div>
                <Slider class="size-slider" :min="20" :max="200" :step="20" v-model:value="rubberSize" />
              </div>
            </template>
            <div class="btn" :class="{ 'active': writingBoardModel === 'eraser' }" v-tooltip="''" @click="changeModel('eraser')">
              <i-icon-park-outline:erase class="icon" />
            </div>
          </Popover>
          <div class="btn" v-tooltip="''" @click="clearCanvas()">
            <i-icon-park-outline:clear class="icon" />
          </div>
          <div class="btn" :class="{ 'active': blackboard }" v-tooltip="''" @click="blackboard = !blackboard">
