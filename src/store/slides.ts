...
export const useSlidesStore = defineStore('slides', {
  state: (): SlidesState => ({
    ...
    templates: [
      { name: 'Warm Orange', id: 'template_1', cover: './imgs/template_1.webp', origin: 'Official template' },
      { name: 'Modern Blue', id: 'template_2', cover: './imgs/template_2.webp', origin: 'Official template' },
      { name: 'Professional Slate', id: 'template_3', cover: './imgs/template_3.webp', origin: 'Official template' },
      { name: 'Soft Pastel', id: 'template_4', cover: './imgs/template_4.webp', origin: 'Official template' },
      { name: 'Fresh Green', id: 'template_5', cover: './imgs/template_5.webp', origin: 'Community template' },
      { name: 'Warm Orange', id: 'template_6', cover: './imgs/template_6.webp', origin: 'Community template' },
      { name: 'Executive Dark', id: 'template_7', cover: './imgs/template_7.webp', origin: 'Community template' },
      { name: 'Clean White', id: 'template_8', cover: './imgs/template_8.webp', origin: 'Community template' },
    ],
  }),
